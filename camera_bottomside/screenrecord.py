...
def splitframes():
    capture = cv2.VideoCapture('C:/Users/alyss/OneDrive/Desktop/videoframes/vidup.avi')
    frameNr = 0
    ...
    while success:
        ...
        success, frame = capture.read()
        cv2.imwrite(f'C:/Users/alyss/OneDrive/Desktop/videoframes/framesup/frame_{frameNr}.png', frame)
