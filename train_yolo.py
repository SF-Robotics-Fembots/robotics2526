...
DATASET_ZIP = IMAGE_REC_DIR / "Crab Species Detection.v1i.yolov11.zip"
DATASET_DIR = IMAGE_REC_DIR / "Crab Species Detection.v1i.yolov11"
DATA_YAML = DATASET_DIR / "data.yaml"
STARTING_MODEL = "yolo11n.pt"
TRAINED_MODEL_PATH = IMAGE_REC_DIR / "crab_species_v1_yolo11.pt"
...
def main():
    parser = argparse.ArgumentParser(description="Unzip and train YOLO on the v1 crab species dataset.")
    parser.add_argument(
        "--unzip-only",
        action="store_true",
